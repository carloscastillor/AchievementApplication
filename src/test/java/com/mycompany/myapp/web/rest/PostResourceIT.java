...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return post;
    }
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
