...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKEMESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIKEMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIKEMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIKEMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIKEMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIKEMESSAGE actions', async () => {
      const expectedActions = [
        {
