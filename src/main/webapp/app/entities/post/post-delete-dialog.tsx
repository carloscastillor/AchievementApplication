...
export const PostDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="achievementApplicationApp.post.delete.question">
        <Translate contentKey="achievementApplicationApp.post.delete.question" interpolate={{ id: postEntity.id }}>
