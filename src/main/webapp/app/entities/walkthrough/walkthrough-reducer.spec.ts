...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WALKTHROUGH_LIST actions', async () => {
    ...
    it('dispatches FETCH_WALKTHROUGH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WALKTHROUGH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WALKTHROUGH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WALKTHROUGH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WALKTHROUGH actions', async () => {
      const expectedActions = [
        {
