...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './like-post.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKEPOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIKEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIKEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIKEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIKEPOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIKEPOST actions', async () => {
      const expectedActions = [
        {
