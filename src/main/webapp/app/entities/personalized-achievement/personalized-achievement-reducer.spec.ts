...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './personalized-achievement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALIZEDACHIEVEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONALIZEDACHIEVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONALIZEDACHIEVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONALIZEDACHIEVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALIZEDACHIEVEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONALIZEDACHIEVEMENT actions', async () => {
      const expectedActions = [
        {
