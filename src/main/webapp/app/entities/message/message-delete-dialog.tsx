...
export const MessageDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="achievementApplicationApp.message.delete.question">
        <Translate contentKey="achievementApplicationApp.message.delete.question" interpolate={{ id: messageEntity.id }}>
