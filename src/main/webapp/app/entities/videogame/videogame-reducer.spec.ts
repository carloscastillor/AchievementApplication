...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './videogame.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOGAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIDEOGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOGAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOGAME actions', async () => {
      const expectedActions = [
        {
